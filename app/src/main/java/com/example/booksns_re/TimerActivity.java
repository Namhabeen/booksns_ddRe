...
public class TimerActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.profile_timer);
            ...
            mStartBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    alert.setTitle("bookTimer");
                    alert.setMessage("읽을 책을 입력");

                    final EditText name= new EditText(TimerActivity.this);
                    alert.setView(name);
            ...
            mStopBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(username.length()>0) {
                        ...
                        showToast(TimerActivity.this, "북타이머를 종료합니다.");
            ...
            mRecordBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //데이터베이스에 저장
                    showToast(TimerActivity.this, "책 '"+username+"' 저장완료");
                }
            });
